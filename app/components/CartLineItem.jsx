...
function CartLineQuantity({ line }) {
  ...
  return (
    <div className="cart-line-quantity flex items-center">
      ...
      <div className="flex justify-between items-center border rounded-md px-1">
...
function CartLineRemoveButton({ lineIds, disabled }) {
  return (
    <CartForm
      ...
      inputs={{ lineIds }}
    >
      <button disabled={disabled} type="submit" className="cursor-pointer" aria-label="Remove item">
